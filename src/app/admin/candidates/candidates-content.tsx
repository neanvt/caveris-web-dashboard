              ...
              <div className="mt-6 border-t pt-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-shrink-0">
                    {editPhotoPreview ? (
                      /* Show NEW photo preview with remove button */
                      <div className="relative">
                        <img
                      ...
                      /* Show EXISTING photo */
                      <img
                        src={getSecurePhotoUrl(selectedCandidate) ?? undefined}
                        alt="Current photo"
                      ...
                      /* Show placeholder icon when no photo */
                            ...
                            setCandidates(prevCandidates => 
                              prevCandidates.map(c => 
                                c.id === selectedCandidate.id 
                                  ? { ...c, photo_url: newPhotoUrl }
                                  : c
                              )
                            );
                            
                            // Update selectedCandidate so the preview updates immediately
                            setSelectedCandidate(prev => 
                              prev ? { ...prev, photo_url: newPhotoUrl } : prev
                            );

                            // Clear the preview states to show the uploaded photo
                            setEditPhotoFile(null);
                            setEditPhotoPreview(null);
