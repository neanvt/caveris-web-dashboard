...
interface CreateVerifierModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export function CreateVerifierModal({
  open,
  onClose,
  onSuccess,
}: CreateVerifierModalProps) {
  const { toast } = useToast();
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [showPassword, setShowPassword] = useState(false);

  const form = useForm<VerifierFormValues>({
  ...
  const onSubmit = async (values: VerifierFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${values.full_name} has been added as a verifier`,
      });
    ...
    <Dialog open={open} onOpenChange={onClose}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new biometric verification personnel to your team
          </DialogDescription>
        </DialogHeader>
